...
-- this is the primary way to use temp tables especially if just querying data and have some complex data I want to put into boxes or these temp tables to use later
